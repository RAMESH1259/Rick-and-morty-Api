...
import { GetLoction } from "../Redux/Action/LocationActions";
import { Get_All_character } from "../Redux/Action/Get-Char-action";
  ...
  return (
    <div className="Wrapper1">
      ...
      <div className="super-div">
        {Whole_character && Whole_character.length ? (
          Whole_character.map((url, i) => (
          ...
          <div className="front-message">
            ...
            <p className="no-character">
              {flag ? "No character Found" : "Please select a location"}
            </p>
          </div>
        )}
      </div>
